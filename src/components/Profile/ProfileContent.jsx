      ...
      {active === 2 && (
        ...
        <h1>Personal <br/>Information</h1>
          <div className="flex justify-center w-full">
            ...
            {/* <p className="absolute top-0 right-0">Change Password</p> */}
          </div>
          <br />
          <br />
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} c  aria-required={true}>
              <div className="w-full flex flex-col md:flex-row gap-8 md:gap-0 800px:flex mt-5 lg:mt-10 block pb-3">
              ...
              <div className="w-full 800px:flex block pb-3 mt-5 lg:mt-10">
                <div className=" w-[100%] 800px:w-[50%]">
...
const AllOrders = () => {
  ...
  return (
    <div className="p-5">
      {/* Table Header */}
      {/* <div className="flex bg-blue-600 text-white p-3  border-b-2 border-b-primary_color">
        <div className="w-3/12 text-primary_color font-bold">Product(s)</div>
        <div className="w-2/12 text-primary_color font-bold">Status</div>
        <div className="w-2/12 text-primary_color font-bold">Items Qty</div>
        <div className="w-2/12 text-primary_color font-bold">Total</div>
        <div className="w-3/12 text-primary_color font-bold">Action</div>
      </div> */}
      ...
      {orders &&
        orders.map((item, index) => (
          ...
          <div key={item._id} className="   flex flex-col gap-4 py-3">
            ...
            <div
              className={`flex items-center p-3  flex-wrap gap-4 ${
                index % 2 === 0 ? "bg-gray-100" : "bg-white"
              }`}
            >
              <div className="w-3/12 flex flex-wrap gap-2">
                {item.cart.map((each_item, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    <img
                      src={each_item.images[0].url}
                      alt=""
...
const Address = () => {
  ...
  return (
    <div className="w-full px-5">
                ...
                <div className="w-full block  flex flex-col items-center gap-[1.5em] p-4">
                  <div className="w-full pb-2">
                    ...
                    <select
                      ...
                      className="w-[100%] border border-primary_color p-2 text-primary_color text-sm h-[40px] rounded-[5px]"
                    >
                  ...
                  <div className="w-full pb-2">
                    ...
                    <select
                      ...
                      className="w-full border border-primary_color p-2 text-primary_color text-sm h-[40px] rounded-[5px]"
                    >
                      <option value="" className=" text-primary_color border-primary_color p-2  block border pb-2">
                  ...
                  <div className=" w-full pb-2">
                    <input
                      type="submit"
                      className={`max-w-[150px] py-[0.5em] mx-auto bg-secondary_color text-text_color w-full mt-5 cursor-pointer`}
                      required
                      readOnly
                    />
                  </div>
      ...
      <div className="flex w-full  md:items-center flex-col md:flex-row justify-between">
        <h1 className="font-[600]  pb-2">
          My Addresses
        </h1>
        <div
          className={`text-[#fff] bg-primary_color p-4 py-4 rounded-md`}
          onClick={() => setOpen(true)}
        >
          <p className="text-text_color">Add New Address +</p>
        </div>
      </div>
      <br />
      {user &&
