        ...
        {loading && (
          <div className="fixed inset-0 bg-[rgba(0,0,0,0.8)] flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg flex items-center space-x-4">
              <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-primary_color"></div>
              <p className="text-text_color font-medium">Creating your account...</p>
            </div>
          </div>
        )}
