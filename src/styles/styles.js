const styles = {
    ...
    heading: 'text-[27px] text-center md:text-start font-[400] font-Poppins pb-[20px]',
    section:'w-11/12 mx-auto max-w-[1300px]',
    productTitle: 'text-[25px] font-[600] font-Poppins text-[#333]',
    productDiscountPrice:"font-bold  ",
    ...
    input:"w-full border border-primary_color p-[0.5em] rounded-[0px] ",
